...
<main class="p-4 h-[100vh]">
    <section class="size-full title relative">
        ...
        <div class="w-full h-2/3 md:w-[60%] md:h-[70%] absolute right-0 bottom-[-40%] xl:bottom-14 overflow-hidden">
            <div class="sq2">
                <Shape/>
        ...
        <div class="w-full h-2/4 md:w-[55%] hidden md:flex  md:absolute md:h-[40%] left-0 md:left-[-10%] bottom-14 mt-20 lg:mt-0">
            <div class="sq3 ">
    ...
    <div class="my-20 hidden items-center md:flex pb-20 gap-4 text-xl">
        <span class="w-64 block bg-black h-[1px]"></span>
        <h3>#Web Development</h3>
    </div>

    <section class="w-full h-fit lg:h-full flex flex-col items-center justify-center mt-[250px] md:mt-0" id="contact">
...
<style lang="postcss">
    ...
    .title .sq1 {
        ...
        bg-[rgb(246_246_246/1)] shadow-[-2px_7px]; 
    }
    ...
    .ps-1 {
        ...
        top-[50%] right-[50%] translate-x-[50%] md:translate-x-0 
    ...
    .ps-1::before {
        @apply w-[2px] xl:w-[270px] bg-gray-900
        left-[50%] 
        top-[-32%] h-[36%]
        md:top-[-64%] md:h-[67%]
        lg:left-[-195px] 
    ...
    .ps-1::after {
        ...
        h-[120%] bottom-[-115%] left-[50%] absolute;
        content: ""
    }

    .diamond-1 {
        @apply size-14 absolute bottom-[55%] right-[42%] flex items-center justify-center; 
    }
    ...
    .diamond-1::before {
        @apply w-[190px] h-[2px] bg-gray-900
        top-[47%] right-[-188px] absolute;
        content: ""
    }

    .diamond-1::after {
        @apply w-[2px] h-[55px] bg-gray-900
        left-[48.5%] top-[-54px] absolute rounded-b-full;
        content: ""
    }

    .ps-2 {
        @apply size-14 absolute bottom-[55%] right-[68.2%] flex items-center justify-center; 
    }
    ...
    .title .sq2 {
        ...
        rounded-[4rem] rounded-tr-none rounded-bl-none shadow-[-7px_7px] bg-[rgb(246_246_246/1)];
    }
    ...
    .title .sq3 {
        ...
        rounded-full shadow-[-7px_7px] bg-[rgb(246_246_246/1)] relative;
    }
